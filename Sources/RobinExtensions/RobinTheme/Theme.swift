...
extension Theme {
  /// Robin's first-party site theme.
  ///
  /// Import `RobinTheme` and assign this theme to an application, then compose pages with the
  /// accompanying ``RobinPage``, ``RobinPanel``, ``RobinLabel``, and ``RobinTitle`` components.
  public static let robin = Theme(
    lightColors: [
      .background: Color(lightness: 0.99, chroma: 0.002, hue: 275),
      .surface: Color(lightness: 1, chroma: 0, hue: 275),
      .surfaceHover: Color(lightness: 0.97, chroma: 0.004, hue: 275),
      .card: Color(lightness: 1, chroma: 0, hue: 275),
    ...
    darkColors: [
      ...
      .surfaceHover: Color(lightness: 0.26, chroma: 0.008, hue: 275),
      .card: Color(lightness: 0.19, chroma: 0.008, hue: 275),
      ...
      .mutedHover: Color(lightness: 0.9, chroma: 0.02, hue: 275),
      .accentHover: Color(lightness: 0.85, chroma: 0.09, hue: 255),
      .accent: Color(lightness: 0.78, chroma: 0.11, hue: 255),
      .onAccent: Color(lightness: 0.16, chroma: 0.008, hue: 275),
