...
extension Theme {
  ...
  public static let `default` = Theme(
    lightColors: [
      ...
      .surface: Color(lightness: 1, chroma: 0, hue: 250),
      .surfaceHover: Color(lightness: 0.96, chroma: 0.01, hue: 250),
      .card: Color(lightness: 1, chroma: 0, hue: 250),
      .cardHover: Color(lightness: 0.96, chroma: 0.01, hue: 250),
      .muted: Color(lightness: 0.49, chroma: 0.02, hue: 250),
      .mutedHover: Color(lightness: 0.4, chroma: 0.02, hue: 250),
      .accentHover: Color(lightness: 0.48, chroma: 0.18, hue: 250),
      .onAccent: Color(lightness: 1, chroma: 0, hue: 250),
    ],
    darkColors: [
      ...
      .surface: Color(lightness: 0.19, chroma: 0.01, hue: 250),
      .surfaceHover: Color(lightness: 0.25, chroma: 0.02, hue: 250),
      .card: Color(lightness: 0.19, chroma: 0.01, hue: 250),
      .cardHover: Color(lightness: 0.25, chroma: 0.02, hue: 250),
      .muted: Color(lightness: 0.75, chroma: 0.02, hue: 250),
      .mutedHover: Color(lightness: 0.88, chroma: 0.02, hue: 250),
      .accentHover: Color(lightness: 0.78, chroma: 0.16, hue: 250),
      .onAccent: Color(lightness: 0.15, chroma: 0.01, hue: 250),
    ],
    typography: [
