...
/// A typed JSON endpoint that handles requests through ``ApplicationResponder``.
public protocol Endpoint: APIRoute, ServerRoute {
  /// The value decoded from the matched path.
  associatedtype Value: Sendable
  /// The route representation declared by the endpoint.
  ...
  /// The path matched by this endpoint.
...
extension Endpoint {
  ...
  /// Transport features required by this endpoint.
