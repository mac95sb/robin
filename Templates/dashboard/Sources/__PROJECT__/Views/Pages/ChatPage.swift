...
struct ChatPage: Page {
  ...
  var body: ComponentContent {
    Stack {
      ...
      Main {
        Stack {
          Text { "WORKSPACE / CONVERSATIONS" }.margin(.zero).starterLink()
        ...
        if !signedIn {
          ...
          Section {
            Heading(.two) { "Choose your username" }.starterTitle()
            UsernameEditor()
          ...
          Section {
            Stack {
              Stack {
                ...
                Stack {
                  ...
                  Text { t("sharedConversation") }.margin(.zero).starterLink()
                }.grid(columns: 1, gap: .xs)
              }.flex(align: .center, gap: .md)
              Stack {
                Text(id: "chat-status") { "Connecting" }.margin(.zero).starterLink()
            ...
            Form(id: "chat-form") {
              ...
              Button(.submit, accessibilityLabel: "Send message") {
                ...
                Text { t("send") }
              }.starterButton().flex(align: .center, gap: .sm)
