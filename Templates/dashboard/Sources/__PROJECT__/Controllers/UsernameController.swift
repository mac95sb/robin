...
struct UsernameController: Controller {
  ...
  private struct SetUsername: APIRoute, ServerRoute {
    ...
    let metadata = RouteMetadata(operationID: "username.set", summary: "Sets your unique username.")
      ...
      do {
        ...
        return try .html(
          ...
          Main {
            ...
            Link(destination) { "Back to conversations" }.starterLink()
          }.grid(columns: 1, gap: .md).starterPage()
        }
      }
