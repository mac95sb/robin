...
This blog uses Robin's typed content, component, and rendering model.

- Keep application structure proportional to the project. Blogs may need only content and `Views`.
